...
import Formulario04 from './components/licencia/Formulario04.vue';
import HistoriaClinica from './components/saludOcupacional/HistoriaClinica.vue';
import JuntaMedicaIndex from './components/saludOcupacional/JuntaMedicaIndex.vue';
import JuntaMedicaForm from './components/saludOcupacional/JuntaMedicaForm.vue';
import JuntaMedicaEvaluacion from './components/saludOcupacional/JuntaMedicaEvaluacion.vue';
import Prestadores from './components/gestion-clinica/Prestadores.vue';
import Establecimientos from './components/gestion-clinica/Establecimientos.vue';
...
const router = new Router({
    ...
    routes: [
        ...
        {
            path: '/formularios/justificacion-inasistencias',
            name: 'formulario04',
            component: Formulario04,
            meta: {
                requiresAuth: true,
            },
        },
        {
            path: '/salud-ocupacional/historia-clinica',
        ...
        {
            path: '/salud-ocupacional/juntas-medicas',
            name: 'juntas-medicas',
            component: JuntaMedicaIndex,
            meta: {
                requiresAuth: true,
            },
        },
        {
            path: '/salud-ocupacional/juntas-medicas/nueva',
            name: 'nueva-junta-medica',
            component: JuntaMedicaForm,
            meta: {
                requiresAuth: true,
            },
        },
        {
            path: '/salud-ocupacional/junta-medica/:id/evaluacion',
            name: 'evaluacion-junta-medica',
            component: JuntaMedicaEvaluacion,
            props: true,
            meta: {
                requiresAuth: true,
            },
        ...
        {
            path: '/gestion-clinica/prestadores',
            name: 'prestadores',
        ...
        {
            path: '/gestion-clinica/establecimientos',
