            ...
            <v-col cols="12">
                <v-card class="my-11 mx-auto" width="700">
                    <v-card-title dark class="headline">
                        Importar Datos de Antiguedades a Agentes
                    </v-card-title>
                    <v-card-text>
                        <v-row>
                            <v-col>
                        ...
                        <v-row
                            class="align-center"
                            v-show="can('importar-antiguedad')"
                        >
                            <v-col cols="4">
                                <div
                                    class="d-flex flex-row justify-content align-center"
                                >
                                    <label class="mx-4 mt-1">Vigente: </label>
                                    <v-switch
                                        v-model="vigente"
                                        class="text-center"
                                        inset
...
export default {
    ...
    methods: {
        ...
        EventSubir() {
            ...
            window.axios
                .post('api/import-excel-personas', formData)
                .then(res => {
                    this.apagarLoading()
